...
const Collection = () => {
  ...
  const toggleCategory = (evt) => {
    if (category.includes(evt.target.value)) {
      setCategory((prev) => prev.filter((item) => item !== evt.target.value));
    } else {
      setCategory((prev) => [...prev, evt.target.value]);
    }
  };

  const toggleSubCategory = (evt) => {
    if (subCategory.includes(evt.target.value)) {
      setSubCtegory((prev) => prev.filter((item) => item !== evt.target.value));
    } else {
      setSubCtegory((prev) => [...prev, evt.target.value]);
    }
  };
